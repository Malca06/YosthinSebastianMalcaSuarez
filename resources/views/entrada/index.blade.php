            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="m-0">Entradas <button class="btn btn-primary" onclick="nuevo()"><i class="fas fa-file"></i> Nuevo</button> <a href="" class="btn btn-success"><i class="fas fa-file-csv"></i> CSV</a></h5>
                    </div>
                    <div class="card-body">
                        <div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover table-sm">
                                    ...
                                    <tbody>
                                       ...
                                       <td>{{ $reg->id }}</td>
                <td>{{ $reg->vehiculo->placa }}</td>
                <td>{{ $reg->fecha }}</td>
                <td>{{ $reg->vehiculo->modelo }}</td>
                <td>{{ $reg->vehiculo->propietario }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
